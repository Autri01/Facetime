                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()){
                            ...
                            User firebaseUser = new User(Objects.requireNonNull(user).getUid(),user.getDisplayName(), Objects.requireNonNull(user.getPhotoUrl()).toString(),"Unknown",500);
                            ...
                            //Log.d("profile",user.getDisplayName());
                        }else{
